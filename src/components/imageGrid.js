...
const features1 = [
  {
    ...
    description: "Inroads is registered as a 501c3 non-profit organization (EIN 84-3054114) in Washington State",
  },
];
      ...
      <div className="bg-indigo-50 ">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-20 sm:px-6 sm:py-16 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          ...
          >
            ...
            <a
              href="https://www.rwandayvchange.org/" target="_blank"
      ...
      <div className="bg-white ">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-20 sm:px-6 sm:py-16 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          ...
          >
            ...
            <a
              href="https://www.makeinroads.org/about-inroads" target="_blank"
              className="mt-6 w-64 inline-block rounded-md border border-transparent bg-amber-400 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700"
            >
              Inroads
            </a>
          </div>
